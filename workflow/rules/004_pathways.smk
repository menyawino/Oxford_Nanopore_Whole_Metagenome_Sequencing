...
rule humann_functional_profiling:
    ...
    output:
        gene_families = "results/004_pathways/humann/{sample}_gene_families.tsv",
        pathways_abundance = "results/004_pathways/humann/{sample}_pathways_abundance.tsv",
        pathways_coverage = "results/004_pathways/humann/{sample}_pathways_coverage.tsv"
    params:
